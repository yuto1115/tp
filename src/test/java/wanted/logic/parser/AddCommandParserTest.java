...
import static wanted.logic.commands.CommandTestUtil.ADDRESS_DESC_BOB;
...
import static wanted.logic.commands.CommandTestUtil.EMAIL_DESC_BOB;
import static wanted.logic.commands.CommandTestUtil.INVALID_ADDRESS_DESC;
import static wanted.logic.commands.CommandTestUtil.INVALID_EMAIL_DESC;
import static wanted.logic.commands.CommandTestUtil.INVALID_NAME_DESC;
import static wanted.logic.commands.CommandTestUtil.INVALID_PHONE_DESC;
...
import static wanted.logic.commands.CommandTestUtil.PHONE_DESC_BOB;
...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + AMOUNT_DESC_BOB + DATE_DESC_BOB + TAG_DESC_FRIEND, new AddCommand(expectedPerson));
        ...
        assertParseSuccess(parser,
                NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + AMOUNT_DESC_BOB + DATE_DESC_BOB
    ...
    public void parse_repeatedNonTagValue_failure() {
        String validExpectedPersonString = NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + AMOUNT_DESC_BOB + DATE_DESC_BOB + TAG_DESC_FRIEND;
